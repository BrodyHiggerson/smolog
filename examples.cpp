...
int main() {
	...
	main_logger.smolog_debug("Hello Smolog!");
	...
	main_logger.smolog_log_at(smolog::Level::Error, "Oh-oh something went wrong :(");
	...
	main_logger.smolog_info("My friend %s is %d years old", "Martin", 24);
	...
	main_logger.smolog_error("Good luck with smolog!")
#endif
